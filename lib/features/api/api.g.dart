...
class _ProductsApiClient implements ProductsApiClient {
  _ProductsApiClient(
    ...
    baseUrl ??= 'https://eshop2024.pythonanywhere.com/api/v1';
  }
  ...
  @override
  Future<Product> getProductsDetails(String slug) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    ...
    final _value = Product.fromJson(_result.data!);
    return _value;
  }
  ...
  @override
  Future<List<Product>> getCategoriesDetails(String slug) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
